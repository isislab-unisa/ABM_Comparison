...
global {
	int nb_preys_init <- 19200;
	int nb_predators_init <- 12800;
	float prey_max_energy <- 1.0;
	float prey_max_transfer <- 0.3;
	float prey_energy_consum <- 0.1;
	float predator_max_energy <- 1.0;
	float predator_energy_transfer <- 0.3;
	float predator_energy_consum <- 0.1;
	float prey_proba_reproduce <- 0.2;
	int prey_nb_max_offsprings <- 2;
	float prey_energy_reproduce <- 0.1;
...
grid vegetation_cell width: 565 height: 565 neighbors: 1 {
	float max_food <- 1.0;
	float food_prod <- 0.1;
...
experiment prey_predator type: gui {
	parameter "Initial number of preys: " var: nb_preys_init min: 0 max: 64000 category: "Prey";
	parameter "Prey max energy: " var: prey_max_energy category: "Prey";
	parameter "Prey max transfer: " var: prey_max_transfer category: "Prey";
	parameter "Prey energy consumption: " var: prey_energy_consum category: "Prey";
	parameter "Initial number of predators: " var: nb_predators_init min: 0 max: 64000 category: "Predator";
...
experiment name type: batch repeat: 5 keep_seed: false until: ( time > 200 ) {	
